...
# Ensure variable cost total is calculated before plotting
variable_cost_total = variable_cost * units_sold

plot_profit_chart(monthly_profit, project_years)
plot_depreciation_chart(depreciation_values)
plot_cost_pie_chart(fixed_cost, variable_cost_total)
